...
export const OBJECTIVE_TYPES: Record<string, ObjectiveMeta> = {
  ...
  // ============= STUDY - Studio (14 objectives - includes school) =============
  // SCHOOL OBJECTIVES (for young users)
  improve_grades: {
    key: 'improve_grades',
  ...
  pass_school_exam: {
    ...
    label: 'Superare esame scuola',
    icon: 'GraduationCap',
    emoji: '🎓',
    category: 'study',
    description: 'Terza media, maturità o altro esame',
    inputMethod: 'milestone',
    brainDetectable: true,
  },
  homework_completion: {
    key: 'homework_completion',
    label: 'Fare i compiti',
    icon: 'CheckCircle',
    emoji: '✅',
    category: 'study',
  ...
  reduce_school_anxiety: {
    key: 'reduce_school_anxiety',
    label: 'Ansia scolastica',
    icon: 'Heart',
    emoji: '😰',
    category: 'study',
    description: 'Gestire ansia da verifiche e interrogazioni',
    inputMethod: 'session_detected',
    brainDetectable: true,
  },
  // UNIVERSITY/ADULT STUDY OBJECTIVES
  pass_exam: {
    key: 'pass_exam',
    label: 'Superare esame università',
    icon: 'GraduationCap',
    emoji: '🎓',
    category: 'study',
    description: 'Supera un esame universitario',
    inputMethod: 'milestone',
    brainDetectable: true,
  },
  study_hours: {
